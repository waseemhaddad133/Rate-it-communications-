...
Follow.prototype.validate= async function(action){
        ...
        if(action =="create"){
                if(doesFollowAlreadyExist){this.errors.push("You are already following this account.")}
        }
        if(action =="delete"){
                if(!doesFollowAlreadyExist){this.errors.push("You can't stop following an account you do not already follow.")}
        }
        // shouldn't folllow ur self
